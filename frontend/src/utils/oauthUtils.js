...
const setInterviewTime = async (interviews) => {
  if (interviews && interviews.length > 0) {
    ...
    for (const interview of interviewDates) {
      const application = await setInterviewApplication(interview);
    }
  }
};

// creates or updates the application with the interview information
const setInterviewApplication = async (interview) => {
